...
### Battle — Data Bridge _(đã refactor)_
...
### Battle — Combat Calculation _(Sprint 2 — hoàn thành)_
...
### Battle — Visual Feedback _(Sprint 3 — hoàn thành)_
...
### Battle — GDD Combat System _(Sprint 4 — hoàn thành)_
...
### Battle — Terrain / Weather _(Sprint 5 — đang làm)_
...
- [x] **Enemy AI thực sự** — `EnemyAIBrain` đã được tách ra file riêng; `CommandPhaseController` đã được dọn sạch code AI cũ
